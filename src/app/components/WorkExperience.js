...
const ExperienceCard = ({ experience, index }) => {
  return (
    ...
    >
      ...
      {/* Timeline dot */}
      <div className="absolute left-[-8px] top-0 w-4 h-4 rounded-full bg-white border-2 border-blue-600 group-hover:border-purple-600 transition-colors duration-300"></div>
